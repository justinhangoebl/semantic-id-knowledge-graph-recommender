...
class ML1MDataset(BaseDataset):
    ...
    def load_inter_data(self):
        return pd.read_csv(self.inter_file, delimiter=self.sep, header=None, engine='python', encoding='latin-1')
    ...
    def load_user_data(self):
        return pd.read_csv(self.user_file, delimiter=self.sep, header=None, engine='python', encoding='latin-1')
